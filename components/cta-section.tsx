...
export function CTASection() {
  return (
    <section className="py-24 lg:py-32 relative overflow-hidden">
      ...
      <ParallaxSection speed={0.3} mouseParallax mouseIntensity={0.02} className="absolute inset-0">
        <motion.div
      ...
      <ParallaxSection speed={0.4} rotateOnScroll className="absolute top-1/4 right-10 w-24 h-24 opacity-20">
        <div className="w-full h-full rounded-full bg-primary blur-xl animate-pulse-glow" />
      </ParallaxSection>

      <ParallaxSection speed={0.35} direction="down" className="absolute bottom-1/4 left-10 w-32 h-32 opacity-15">
